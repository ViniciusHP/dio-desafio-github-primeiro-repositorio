...
diferente o prato principal dessa reunião é a mandioca. Cada um deles
come de uma a dez porções de mandioca e eles sempre avisam a Marlene com
...
Marlene por sua vez sempre come 225 gramas de mandioca. Cansada de todo
ano ter que calcular quanta mandioca preparar ela te desafiou para escrever
...
const porcoesDeCadaConvidado = [300, 1500, 600, 1000, 150];
const porcaoMarlene = 225;
let total = porcaoMarlene;

for(let porcao of porcoesDeCadaConvidado){
  total += porcao * parseInt(gets());
}
